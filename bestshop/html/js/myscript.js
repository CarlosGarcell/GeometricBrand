...
function scrolled_menu() {
	...
	var paddingTop = Math.abs(headerH + toplineH);
	
	jQuery('header').css('margin-bottom',menublockH + 'px');
	jQuery('.menu_block').css('top',paddingTop + 'px');
	
	if (jQuery(window).scrollTop() > paddingTop) {
...
/*-----------------------------------------------------------------------------------*/
jQuery(window).load(function () {
	jQuery('.home_banner_wrap').each(function() {
		var homeBannerTitleW = jQuery(this).find('h4').width();
		var homeBannerSubW = jQuery(this).find('.subtitle').width() + 18;
		var homeBannerSepW = Math.abs((homeBannerTitleW - homeBannerSubW)/2);
		
		var homeBannerTitle = jQuery(this).find('h4');
		var homeBannerSub = jQuery(this).find('.subtitle');
		
		if (homeBannerSub.css('width') > homeBannerTitle.css('width')) {
			jQuery(this).find('.subtitle span').hide();
		}
		
		jQuery(this).find('.subtitle span:first').css({'left':'-'+homeBannerSepW+'px', 'width':homeBannerSepW+'px'});
		jQuery(this).find('.subtitle span:last').css({'right':'-'+homeBannerSepW+'px', 'width':homeBannerSepW+'px'});
	});
});
...
/*-----------------------------------------------------------------------------------*/
jQuery(document).ready(function() {	
	jQuery('footer .twitter_wrap').tweet({
		modpath: 'twitter/',
		count: 2,
