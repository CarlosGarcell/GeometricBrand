...
<body>
	...
	<div id="page">
			...
			<div class="top_line clearfix">
				...
				<div class="top_search_wrap">
					<form id="top-search-form" action="">
						<input type="text" name="text" value="" placeholder="Search For Products" />
					...
					<div class="row">
						...
						<div class="col-sm-4 clearfix">
							...
							<div class="mini_cart">
								...
								<a class="cart_link" href="javascript:void(0);">Your Cart</a>
								<span class="cart_total">€ 514, 000</span>
							</div><!-- //Mini cart -->
						</div>
					</div>
				</div>
			...
			<div class="menu_block">
				<div class="container">
					...
					<ul id="main_menu">
						...
						<li class="current-menu-item"><a href="contacts.html">Contacts</a></li>
					</ul><!-- //Main Menu -->
				</div><!-- //Main Menu Block -->
			</div>
		</header><!-- //Header -->
		...
		<!-- MAP -->
		<div class="map" id="map" style="height: 400px;"></div><!-- //MAP -->
